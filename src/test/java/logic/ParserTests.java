...
public class ParserTests {
	...
	public void testFormRelationship() {
		...
		Map<Relationship, TreeSet<Edge>> map = node0.getRelationshipMap();
		Assert.assertNotNull(map.get(Relationship.CO_WORKER));
		Assert.assertNotNull(map.get(Relationship.FAMILY));
		TreeSet<Edge> coWorkers = map.get(Relationship.CO_WORKER);
		...
		TreeSet<Edge> family = map.get(Relationship.FAMILY);
